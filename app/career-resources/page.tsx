...
export const metadata: Metadata = { title: "Career Resources | Horizon Jobs", description: "Important information about Horizon Jobs job listings, external links, and employment information.", };
