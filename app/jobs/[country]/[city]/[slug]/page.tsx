...
export default async function JobDetailPage({
  ...
  /*
   * Protect against a slug being opened
   * under the wrong country/city URL.
   */
  if (
    slugify(
      job.country
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <header className="p-7 sm:p-10">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-4xl dark:bg-slate-800">
                {flag}
              </div>
            </div>
